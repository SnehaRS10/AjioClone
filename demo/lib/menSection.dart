  ...
  Widget _buildProductItem(BuildContext context, int index) {
    ...
    switch (index) {
      case 1:
        ...
        productPrice = 10.0;
        productImage = "men/men_1.jpg";
        productRating = 4.0;
        break;
      case 2:
        productName = "Product 2";
        productPrice = 15.0;
        productImage = "men/men_2.jpg";
        productRating = 4.0;
        break;
      case 3:
        productName = "Product 3";
        productPrice = 20.0;
        productImage = "men/men_3.jpg";
        productRating = 4.0;
        break;
      case 4:
        productName = "Product 4";
        productPrice = 25.0;
        productImage = "men/men_4.jpg";
        productRating = 4.3;
        break;
      case 5:
        productName = "Product 5";
        productPrice = 30.0;
        productImage = "men/men_5.jpg";
        productRating = 4.8;
        break;
      case 6:
        productName = "Product 6";
        productPrice = 35.0;
        productImage = "men/men_6.jpg";
        productRating = 4.0;
        break;
      default:
